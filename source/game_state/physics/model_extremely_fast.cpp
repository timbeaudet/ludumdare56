...
LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::ExtremelyFastPhysicsModel(icePhysics::World& physicalWorld) :
	RaycastVehiclePhysicsModelInterface(physicalWorld, DefaultVehicle()),
	mEngineSpeed(0.0),
	mPreviousVelocity(iceVector3::Zero()),
	mGearBox(GameState::Gear::Sixth),
	mBodyTilter()
{
...
LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::~ExtremelyFastPhysicsModel(void)
{
}

//--------------------------------------------------------------------------------------------------------------------//

void LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::OnResetRacecarForces(void)
{
...
void LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::OnSimulate(const RacecarControllerInterface& racecarController)
{
...
void LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::OnDebugRender(void) const
{
...
icePhysics::Angle LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::GetSteeringAngle(
...
void LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::SimulateFizzics(const RacecarControllerInterface& racecarController)
{
...
void LudumDare56::GameState::PhysicsModels::ExtremelyFastPhysicsModel::SimulateTireGrip(const RacecarControllerInterface& racecarController)
{
	if (true)
	{
